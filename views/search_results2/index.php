...
<body onload="loading()">
    <?php
    $tomato = $this->accession_number;
    $id_tomato = $this->id_accession_number;
    $result_search = $this->num_result;
            ...
            <div class="card">
              ...
              <div class="card-body top">
                  <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="javascript:history.go(-1)">Physical-Genome Search</a>
                    </li>
...
<p class="text-result">Search results <span class="red"><?php echo $result_search; ?></span> items</p>
        ...
        <div class="card " >
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 hidden" id="disp" frameborder='0' width='100%' height='100%' scrolling='no'>
                        <?php
                        require 'views/table_display2/index.php';
                        ?>
