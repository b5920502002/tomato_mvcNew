...
<div id="table_display">
    ...
    $i = 0;
    $count_diff = 0;
    //echo sizeof($accession_number).'-';
    //echo sizeof($id_tomato);

    for($j = 0;$j < sizeof($id_tomato);$j++) {
        ...
        <div class="d-inline-block label-pos" style="width: 50px;">
            ...
            <?php echo "<button  type='button' data-accnumber='$accession_number[$j]' data-id='$id_tomato[i]'  class='btn btn-danger btn-sm btn-send'>$accession_number[$j]</button><br><br>"; ?>
            </form>
        </div>
