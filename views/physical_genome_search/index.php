...
<div class="">
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      ...
      <h4 class="card-title mt-5" style="margin: 30px; position: absolute;">Physical & Genome Search</h4>

      <form action="search_results2" method="post">
      ...
      <div class="card-body">
        ...
        <form action="search_results2" id="physical_search" method="post">
