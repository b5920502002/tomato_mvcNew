...
<div class="card">
    <div class="card-body">
        ...
        <h2>Edit Detail</h2>
        <form class="forms-sample" id="create_detail" action="<?php echo URL ?>/General_Infomation/insert_detail" method="post">
            ...
            <div class="form-group">
                <input name="type_crop" type="radio" id="cb1" value="circle" checked>
                <label for="cd1" style="vertical-align:text-top;text-align:center; padding:0 10px 0 10px;">Crop by circle </label>
                <input name="type_crop" type="radio" id="cb2" value="square">
...
<script>
     ...
     */
            ...
            $('#preview_image').attr("src", base_url+image);
            ...
            $('.upload-result').on('click', function (ev) {
                $uploadCrop.croppie('result', {
                    ...
                    if (resp == 'data:,') {
                        ...
                        $.ajax({
                            url: base_url+"/general_infomation/crop_image",
                            method: "post",
